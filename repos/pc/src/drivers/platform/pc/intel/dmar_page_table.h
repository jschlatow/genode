...
#ifndef _SRC__DRIVERS__PLATFORM__PC__INTEL__DMAR_PAGE_TABLE_H_
#define _SRC__DRIVERS__PLATFORM__PC__INTEL__DMAR_PAGE_TABLE_H_
...
#endif /* _SRC__DRIVERS__PLATFORM__PC__INTEL__DMAR_PAGE_TABLE_H_ */
