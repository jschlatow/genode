/*
 * \brief  Zynq-specific helper functions for GDB server
...
extern "C" int genode_fetch_register(int regno, unsigned long *reg_content)
{
	...
	if (in_syscall(thread_state) || thread_state.unresolved_page_fault) {
		...
		{
			case R0: *reg_content = thread_state.r0; PDBG("PC = %8lx", *reg_content); return 0;
			case R1: *reg_content = thread_state.r1; PDBG("PC = %8lx", *reg_content); return 0;
			case R2: *reg_content = thread_state.r2; PDBG("PC = %8lx", *reg_content); return 0;
			case R3: *reg_content = thread_state.r3; PDBG("PC = %8lx", *reg_content); return 0;
			case R4: *reg_content = thread_state.r4; PDBG("PC = %8lx", *reg_content); return 0;
			case R5: *reg_content = thread_state.r5; PDBG("PC = %8lx", *reg_content); return 0;
			case R6: *reg_content = thread_state.r6; PDBG("PC = %8lx", *reg_content); return 0;
			case R7: *reg_content = thread_state.r7; PDBG("PC = %8lx", *reg_content); return 0;
