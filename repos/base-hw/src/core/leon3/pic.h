/*
 * \brief  Interrupt controller of LEON3
 * \author Norman Feske
 * \date   2013-04-05
 *
 * TODO implement LEON3 PIC
 */
...
#ifndef _LEON3__PIC_H_
#define _LEON3__PIC_H_
...
namespace Kernel
{
	class Pic : Genode::Mmio
	{
		...
		public:
			...
			enum {
				MAX_INTERRUPT_ID = 1, /* FIXME MAX_INTERRUPT_ID */
			};

			Pic() : Genode::Mmio(Genode::Board::IRQMP_MMIO_BASE) { mask(); }
