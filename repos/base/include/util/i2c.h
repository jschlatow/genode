...
namespace Genode {
	...
	template<typename DRIVER, unsigned REG_ADDR_SIZE> class I2c_base;
...
/**
 * Raw IO access implementation for I2C
 */
template<typename DRIVER, unsigned REG_ADDR_SIZE>
class Genode::I2c_base
{
	friend Io_base;
	...
	public:
		 ...
		 */
		I2c_base(addr_t const slave, DRIVER &driver) : _slave(slave), _driver(driver) { }
};
 ...
 */
template <typename DRIVER, unsigned REG_ADDR_SIZE>
struct Genode::I2c : I2c_base<DRIVER, REG_ADDR_SIZE>, Io<I2c_base<DRIVER, REG_ADDR_SIZE>>
{
	/**
	 * Constructor
	 *
	 ...
	 */
	I2c(addr_t const slave, DRIVER &driver) : I2c_base<DRIVER, REG_ADDR_SIZE>(slave, driver),
	                                          Io<I2c_base<DRIVER, REG_ADDR_SIZE>>(*static_cast<I2c_base<DRIVER,REG_ADDR_SIZE> *>(this)) { }
};
