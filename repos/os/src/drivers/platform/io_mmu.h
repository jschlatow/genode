	...
	public:
		...
		class Domain : private Registry<Domain>::Element
		{
			...
			public:
				...
				virtual void enable_pci_device(Io_mem_dataspace_capability const, Pci::Bdf const) = 0;
				virtual void disable_pci_device(Io_mem_dataspace_capability const, Pci::Bdf const) = 0;
				...
				Domain(Io_mmu & io_mmu, Allocator & md_alloc, Registry<Dma_buffer> const & buffer_registry)
